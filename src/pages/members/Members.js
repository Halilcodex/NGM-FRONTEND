		...
		return (
			<div class="cover-container d-flex w-100 h-100 mx-auto flex-column">
				<div class="members">
					...
					<div class="container">
						<div class="row">
							<div class="member-row col-lg-4 col-md-6 col-sm-12" id="0" onClick={this.bar}>
								<OverlayTrigger
									id="0"
									placement="bottom"
								...
								>
									<img src="http://fakeimg.pl/250x250/" class="img-responsive member-img" id="0" />
								</OverlayTrigger>
							...
							<div class="member-row col-lg-4 col-md-6 col-sm-12">
								<OverlayTrigger
									...
									overlay={this.renderTooltip}
								>
									<img src="http://fakeimg.pl/250x250/" class="img-responsive member-img" id="1" />
								</OverlayTrigger>
								<h3>Second Member</h3>
								<p>Cras justo odio, dapibus ac facilisis in</p>
							</div>
							...
							<div class="member-row col-lg-4 col-md-6 col-sm-12">
								<OverlayTrigger
									...
									overlay={this.renderTooltip}
								>
									<img src="http://fakeimg.pl/250x250/" class="img-responsive member-img"  id="2"/>
								</OverlayTrigger>
								<h3>Third Member</h3>
								<p>Cras justo odio, dapibus ac facilisis in</p>
							</div>
